...
imu_pub = rospy.Publisher(mavros.get_topic('imu', 'data'), Imu, queue_size=10)
state_sub = rospy.Subscriber(mavros.get_topic('state'), State, state_cb)
imu_sub = rospy.Subscriber(mavros.get_topic('imu', 'data'), Imu, update_imu)
